...
public class ContactDetail {
    ...
    public String toString() {
        return "ContactDetail [firstName=" + firstName + ", lastName=" + lastName + ", address=" + address + ", city="
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ContactDetail)) return false;
        ContactDetail person1 = (ContactDetail) object;
